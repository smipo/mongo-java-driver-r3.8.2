...
public interface MongoIterable<TResult> extends Iterable<TResult> {
    ...
    default MongoCursor<TResult> iterator(ReadPreference readPreference){
        throw new IllegalArgumentException("iterator does not support");
    }

    @Nullable
    default TResult first(ReadPreference readPreference){
        throw new IllegalArgumentException("first does not support");
    }
    /**
