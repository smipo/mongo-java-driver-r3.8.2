...
class MongoCollectionImpl<TDocument> implements MongoCollection<TDocument> {
    ...
    @Override
    @Deprecated
    public long count(ReadPreference readPreference) {
        return count(new BsonDocument(), new CountOptions(),readPreference);
    }
    ...
    @Override
    @Deprecated
    public long count(final Bson filter,ReadPreference readPreference) {
        return count(filter, new CountOptions(),readPreference);
    }
    ...
    @Override
    @Deprecated
    public long count(final Bson filter, final CountOptions options,ReadPreference readPreference) {
        return executeCount(null, filter, options, CountStrategy.COMMAND,readPreference);
    }
    ...
    @Override
    @Deprecated
    public long count(final ClientSession clientSession,ReadPreference readPreference) {
        return count(clientSession, new BsonDocument(),readPreference);
    }
    ...
    @Override
    @Deprecated
    public long count(final ClientSession clientSession, final Bson filter,ReadPreference readPreference) {
        return count(clientSession, filter, new CountOptions(),readPreference);
    }
    ...
    @Override
    @Deprecated
    public long count(final ClientSession clientSession, final Bson filter, final CountOptions options,ReadPreference readPreference) {
        notNull("clientSession", clientSession);
        return executeCount(clientSession, filter, options, CountStrategy.COMMAND,readPreference);
    }
    ...
    @Override
    public long countDocuments(ReadPreference readPreference) {
        return countDocuments(new BsonDocument(),readPreference);
    }
    ...
    @Override
    public long countDocuments(final Bson filter,ReadPreference readPreference) {
        return countDocuments(filter, new CountOptions(),readPreference);
    }
    ...
    @Override
    public long countDocuments(final Bson filter, final CountOptions options,ReadPreference readPreference) {
        return executeCount(null, filter, options, CountStrategy.AGGREGATE,readPreference);
    }
    ...
    @Override
    public long countDocuments(final ClientSession clientSession,ReadPreference readPreference) {
        return countDocuments(clientSession, new BsonDocument(),readPreference);
    }
    ...
    @Override
    public long countDocuments(final ClientSession clientSession, final Bson filter,ReadPreference readPreference) {
        return countDocuments(clientSession, filter, new CountOptions(),readPreference);
    }
    ...
    @Override
    public long countDocuments(final ClientSession clientSession, final Bson filter, final CountOptions options,ReadPreference readPreference) {
        notNull("clientSession", clientSession);
        return executeCount(clientSession, filter, options, CountStrategy.AGGREGATE,readPreference);
    }
    ...
    private long executeCount(@Nullable final ClientSession clientSession, final Bson filter, final CountOptions options,
                              final CountStrategy countStrategy,ReadPreference originalReadPreference) {
        return executor.execute(operations.count(filter, options, countStrategy), originalReadPreference == null ? readPreference : originalReadPreference, readConcern, clientSession);
    }
